            ...
            <div className="max-w-[1720px] mx-auto w-full flex items-center justify-between px-6 py-4">
                ...
                <div className="flex items-center justify-center flex-1 mx-10 min-w-0">
                    ...
                    <div className="bg-[#F1F5FF] p-2 rounded-lg flex-shrink-0">
                        <Image src="/images/cameraIcon.svg" alt="Camera" width={32} height={32} />
                    </div>

                    {/* Search Box */}
                    <div className="flex items-center gap-2 bg-[#F1F5FF] rounded-xl pl-3 py-2 relative ml-6 w-full max-w-[671px] min-w-0">

                        <Image src="/images/mic-02.svg" alt="Mic" width={32} height={32} className="flex-shrink-0" />
                ...
                <div className="flex items-center gap-8 flex-shrink-0">
                    <Image src="/images/translate.svg" alt="Translate" width={32} height={32} className="cursor-pointer" />
                    <Image src="/images/shopping-cart-02.svg" alt="Cart" width={32} height={32} className="cursor-pointer" />

                    <button className="flex items-center gap-2">
                        <Image src="/images/user-circle.svg" alt="User" width={32} height={32} />
