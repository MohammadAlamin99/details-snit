            ...
            <div className="mx-auto max-w-[1720px] bg-white rounded-t-[112px] px-20 pt-14 pb-6 max-md:px-6 max-md:pt-10 max-md:rounded-t-[48px]">
                ...
                <div className="hidden md:flex flex-row items-start justify-between gap-8">
                    ...
                    <div className="flex flex-col gap-4 max-w-[220px]">
                        <Image src="/images/footerlogo.png" alt="Logo" width={169} height={10031} />
                        ...
                        <div className="flex flex-col gap-[20px]">
                            ...
                            <ul className="flex flex-col gap-2">
                                {["Products", "Categories", "Campaigns"].map((item) => (
                                    <li key={item}>
                                        <Link href="#" className="text-[12px] text-black leading-[1.8] font-medium font-inter">
                                            {item}
                                        </Link>
                                    </li>
                                ))}
                ...
                <div className="flex md:hidden flex-col items-center gap-4 pb-28">
                    {/* Logo */}
                    <Image src="/images/footerlogo.png" alt="Logo" width={140} height={40} />
                    ...
                    <div className="flex flex-row items-center gap-6 mt-1">
                        ...
                        <Link href="#" aria-label="Website">
                            <Image src="/images/global.svg" alt="Globe" width={24} height={24} />
                        </Link>
                    </div>

                    {/* Website URL */}
                    <Link href="https://www.opbd.shop" className="text-[13px] text-[#3FC3D7] font-medium font-inter">
                        www.opbd.shop
                    </Link>
                </div>
